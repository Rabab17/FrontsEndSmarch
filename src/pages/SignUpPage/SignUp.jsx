  ...
  return (
    <div className="min-h-screen flex flex-col items-center mb-10 pt-10 md:pt-20 bg-blue-50 text-center px-4">
      ...
      <div className="flex flex-col md:flex-row gap-6 items-center">
        {/* زر "أريد الحجز كعميل" */}
        <div onClick={() => { nav('/signupuser', { state: { userType: "user" } }) }} className="flex-1 bg-blue-600 text-white rounded-lg shadow-md p-6 transition-transform transform hover:scale-105 cursor-pointer w-64 h-64 md:w-80 md:h-80 flex flex-col justify-center">
