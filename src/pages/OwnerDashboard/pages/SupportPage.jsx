      ...
      <div className="p-4 rounded-lg shadow">
        <table className="w-full">
          ...
          <tbody>
            {tickets.map((ticket) => (
              <tr key={ticket.id}>
                <td className="py-5 px-2 text-center text-lg">{ticket.id}</td>
                <td className="py-5 px-2 text-center text-lg">{ticket.username}</td>
                <td className="py-5 px-2 text-center text-lg">{ticket.date}</td>
                <td className="py-5 px-2 text-center text-lg">{ticket.subject}</td>
                <td className="py-5 px-2 text-center text-lg">
                  <span
                    className={`px-3 py-1 text-white ${ticket.statusColor} rounded-lg`}
                  >
                    {ticket.status}
                  </span>
                </td>
