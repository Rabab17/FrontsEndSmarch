...
export default function SidebarDashboard({ isOpen }) {
    ...
    const [isDropdownOpen, setIsDropdownOpen] = useState(false); // حالة للتحكم في ظهور القائمة المنسدلة
    ...
    const toggleDropdown = () => {
        setIsDropdownOpen((prev) => !prev); // تغيير حالة القائمة المنسدلة
    };
            ...
            <div className="mt-5 text-center">
                ...
                <div className="space-y-6 md:space-y-8">
                    ...
                    <div
                        ...
                        onClick={toggleDropdown} // عند الضغط، قم بتبديل حالة القائمة المنسدلة
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 32 32"
                            ...
                            <ul className="flex flex-col">
                                <li>
                                    <button 
                                        ...
                                        onClick={() => nav("/ownerdashboard/TicketSend")}
                                    >
                                        التذاكر المرسلة
                                    </button>
                                </li>
                                <li>
                                    <button 
                                        className="block px-4 py-2 text-gray-800 hover:bg-gray-200" 
                                        onClick={() => nav("/ownerdashboard/support")}
                                    >
                                        التذاكر المستلمة
                                    </button>
                                </li>
